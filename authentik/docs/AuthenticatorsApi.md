...
with authentik.ApiClient(configuration) as api_client:
    ...
    api_instance = authentik.AuthenticatorsApi(api_client)
...
with authentik.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = authentik.AuthenticatorsApi(api_client)
    duo_device_request = authentik.DuoDeviceRequest() # DuoDeviceRequest | 
...
with authentik.ApiClient(configuration) as api_client:
    ...
    api_instance = authentik.AuthenticatorsApi(api_client)
    id = 56 # int | A unique integer value identifying this Duo Device.
    patched_duo_device_request = authentik.PatchedDuoDeviceRequest() # PatchedDuoDeviceRequest |  (optional)
...
with authentik.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = authentik.AuthenticatorsApi(api_client)
    sms_device_request = authentik.SMSDeviceRequest() # SMSDeviceRequest | 
...
with authentik.ApiClient(configuration) as api_client:
    ...
    api_instance = authentik.AuthenticatorsApi(api_client)
    id = 56 # int | A unique integer value identifying this SMS Device.
    patched_sms_device_request = authentik.PatchedSMSDeviceRequest() # PatchedSMSDeviceRequest |  (optional)
...
with authentik.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = authentik.AuthenticatorsApi(api_client)
    static_device_request = authentik.StaticDeviceRequest() # StaticDeviceRequest | 
...
with authentik.ApiClient(configuration) as api_client:
    ...
    api_instance = authentik.AuthenticatorsApi(api_client)
    id = 56 # int | A unique integer value identifying this static device.
    patched_static_device_request = authentik.PatchedStaticDeviceRequest() # PatchedStaticDeviceRequest |  (optional)
...
with authentik.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = authentik.AuthenticatorsApi(api_client)
    totp_device_request = authentik.TOTPDeviceRequest() # TOTPDeviceRequest | 
...
with authentik.ApiClient(configuration) as api_client:
    ...
    api_instance = authentik.AuthenticatorsApi(api_client)
    id = 56 # int | A unique integer value identifying this TOTP device.
    patched_totp_device_request = authentik.PatchedTOTPDeviceRequest() # PatchedTOTPDeviceRequest |  (optional)
...
with authentik.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = authentik.AuthenticatorsApi(api_client)
    web_authn_device_request = authentik.WebAuthnDeviceRequest() # WebAuthnDeviceRequest | 
...
with authentik.ApiClient(configuration) as api_client:
    ...
    api_instance = authentik.AuthenticatorsApi(api_client)
    id = 56 # int | A unique integer value identifying this WebAuthn Device.
    patched_web_authn_device_request = authentik.PatchedWebAuthnDeviceRequest() # PatchedWebAuthnDeviceRequest |  (optional)
